...
class IDOL(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            output, loss_dict = self.detr(images, det_targets,ref_targets, self.criterion, train=True) # We'll change this function with DiffusionInst
            ...
            output = self.detr.inference_forward(images, size_divisib=32) # We'll change here too
            ...
            if video_len > clip_length:
                ...
                for c in range(num_clips):
                    ...
                    clip_output = self.detr.inference_forward(clip_images) # We'll change here too
                ...
                images = self.preprocess_image(batched_inputs)
                output = self.detr.inference_forward(images) # We'll change here too
